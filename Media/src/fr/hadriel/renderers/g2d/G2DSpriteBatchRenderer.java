...
public class G2DSpriteBatchRenderer extends G2DBatchRenderer<ImageRegion> {
    public static final int DEFAULT_CAPACITY = 600_000;

    private final TextureSampler2D sampler2D;

    public G2DSpriteBatchRenderer() {
        this(DEFAULT_CAPACITY);
    }

    public G2DSpriteBatchRenderer(int vertexCapacity) {
        super(Shader.GLSL(G2DSpriteBatchRenderer.class.getResourceAsStream("sprite_shader.glsl")),
                new VertexAttribute[] {
