        ...
        if (error != GL_FRAMEBUFFER_COMPLETE) {
            switch (error) {
                ...
                case GL_FRAMEBUFFER_INCOMPLETE_DRAW_BUFFER:
                    logger.severe("The value of GL_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE is GL_NONE for any color attachment point(s) named by GL_DRAW_BUFFERi"); break;
                case GL_FRAMEBUFFER_INCOMPLETE_READ_BUFFER:
                    logger.severe("GL_READ_BUFFER is not GL_NONE and the value of GL_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE is GL_NONE for the color attachment point named by GL_READ_BUFFER"); break;
                ...
                case GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE:
                    logger.severe("The value of GL_RENDERBUFFER_SAMPLES is not the same for all attached renderbuffers"); break;
                default:
